...
void Crypto();
void CryptoParam(unsigned char *remotePubKey, size_t remotePubKeyLen);
void freeCrypto();
...
extern EVP_PKEY *localKeypair;
extern EVP_PKEY *remotePublicKey;

extern EVP_CIPHER_CTX *rsaEncryptContext;
extern EVP_CIPHER_CTX *aesEncryptContext;

extern EVP_CIPHER_CTX *rsaDecryptContext;
extern EVP_CIPHER_CTX *aesDecryptContext;

extern unsigned char *aesKey;
extern unsigned char *aesIv;

extern size_t aesKeyLength;
extern size_t aesIvLength;
